<template>
    <div class="PortfolioTitle">
      <div class="title-letter-wrapper">
        <PortfolioLetter v-for="letter in letters" v-bind:key="letter.index" :text="letter.text" :trigger="letter.trigger" :override="override || start"/>
      </div>
...
<script>
import PortfolioLetter from '@/components/PortfolioLetter.vue'
