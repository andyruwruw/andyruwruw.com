<template>
    <div class="Title">
      <div class="title-letter-wrapper">
        <TitleLetter v-for="letter in letters" v-bind:key="letter.index" :text="letter.text" :trigger="letter.trigger" :override="override || start"/>
      </div>
...
<script>
import TitleLetter from '@/components/TitleLetter.vue'
