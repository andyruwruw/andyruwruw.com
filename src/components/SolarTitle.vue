<template>
    <div class="SolarTitle">
      <div  class="title-letter-wrapper">
        <SolarLetter  v-for="letter in letters" v-bind:key="letter.index" :text="letter.text" :trigger="letter.trigger" :override="overrideComp"/>
      </div>
...
<script>
import SolarLetter from '@/components/SolarLetter.vue'
